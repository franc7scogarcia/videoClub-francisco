...
public interface ILiterales {
    ...
    */
    ...
    public static final String mnuPrincipalOpcion4 = "4.- Devoluciones";
    ...
    */
    public static final String elegirOpcion = "Por favor elegir una opción (nro.): ";
    public static final String realizarOtraOperacion = "¿Desea realizar otra operación (S/N): ";
    public static final String confirmacion = "¿Desea guardar los datos del cliente?: (S/N): ";
